(function() {
  ...
  var countDownDate = new Date("Nov 29, 2020 20:30:00").getTime();
...
function initMap() {
  ...
  var mymap = L.map('map').setView([21.803938, 75.615728], 15);

  L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoicmFodWxzYWdvcmUiLCJhIjoiY2tobTlubDUzMGVrcjJ3cm5raXNwOWh5ZiJ9.9ZLRtAu5GiJxIx4Uy4mgDg', {
    maxZoom: 18,
  ...
  L.marker([21.803938, 75.615728], {icon: greenIcon}).addTo(mymap)
    .bindPopup("<b>Tirupati Township</b>, Near Sancheti Oil Mill, Bistan Naka, Khargone").openPopup();
